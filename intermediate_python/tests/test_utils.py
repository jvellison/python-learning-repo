...
def test_format_dates():
    ...
    dmy_test_date = pd.Series([pd.to_datetime("01/01/2025", format = "%d/%m/%Y"), pd.NaT ]) # series of dates to compare to
...
def test_clean_903_table(dummy_header):
    ...
    # pd.testing.assert_series_equal(output["ETHNICITY"], pd.Series[])
